...
<div style="height:45px;width:100%;background-color:black;position: fixed;margin-top:75px;float:left;top:0px;right:0px;">
  ...
  <div class="dropdown" style="float: right;">
    <a class="dropbtn" href="../index.php" style="margin-top: 1px;">Logout</a>
  </div>
</div>
<!--<div style="float: right;margin-top: 300px;margin-right: 550px;"><a href="ordered-ticket.php" style="margin-top: 1px;"></a></div>-->
<?php
	include('db.php');
?>
		<div class="form">
