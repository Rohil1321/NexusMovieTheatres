...
?>
  ...
  <u><h1 style="text-decoration: none;color: black;margin-top:200px; margin-left: 10px">Movies :- </h1></u>
  ...
  <a href="viewmv.php?id=10"><img  src="..\upload\master.jpg" style="margin-left: 10px;margin-top: 40px; height: 300px;width: 30%;"></a>
  <a href="viewmv.php?id=11"><img  src="..\upload\krrish1.jpg" style="margin-left: 50px;margin-top: 40px; height: 300px;width: 30%;"></a>
  <a href="viewmv.php?id=2"><img  src="..\upload\karnan.jpg" style="margin-left: 50px;margin-top: 40px; height: 300px;width: 30%;"></a>
  ...
  <a href="viewmv.php?id=3"><img  src="..\upload\kombat.jpg" style="margin-left: 10px;margin-top: 40px; height: 300px;width: 30%;"></a>
  <a href="viewmv.php?id=12"><img  src="..\upload\godzilla.jpg" style="margin-left: 50px;margin-top: 40px; height: 300px;width: 30%;"></a>
  <a href="viewmv.php?id=14"><img  src="..\upload\justice.jpg" style="margin-left: 50px;margin-top: 40px; height: 300px;width: 30%;"></a>
  ...
  <a href="viewmv.php?id=14" style="text-decoration: none; margin-left: 260px;"><big>Zack Snyder's Justice League</big></a>
	...
	<div style="height:200px;width:101.2%;background-color:black;margin-top:40px;float:left;margin-left: -8px;"><br><br><br><br>
